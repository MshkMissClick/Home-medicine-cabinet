...
import { Card, Button, CardContent, Typography, IconButton, Box, Dialog, DialogActions, DialogContent, DialogContentText, DialogTitle } from '@mui/material';
...
const MedicineList = ({ medicines, onEdit, onDelete }: MedicineListProps) => {
    const [openDialog, setOpenDialog] = useState<number | null>(null); // Состояние для диалога

    const handleDeleteClick = (id: number) => {
        console.log('Delete clicked for ID:', id); // Отладка
        setOpenDialog(id);
    };
